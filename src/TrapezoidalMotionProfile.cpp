#include "motion_control/TrapezoidalMotionProfile.h"
#include <math.h>
#include <cstdio>

MotionControl::TrapezoidalMotionProfile::TrapezoidalMotionProfile(double target, double maxVelocity, double maxAcceleration) :
    MotionProfile1D() {
    vi = 0;
    vf = 0;
...
MotionControl::ProfilePoint1D MotionControl::TrapezoidalMotionProfile::getAtTime(double t) {
...
double MotionControl::TrapezoidalMotionProfile::duration() {
